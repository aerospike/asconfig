...
// renderOutputf safely writes to stdout with error handling.
func renderOutputf(format string, args ...any) {
	if _, err := fmt.Fprintf(os.Stdout, format, args...); err != nil {
		// Use renderErrorf for consistency
		renderErrorf("Error rendering output: %v\n", err)
	}
}

// renderErrorf writes error messages to stderr.
func renderErrorf(format string, args ...any) {
	fmt.Fprintf(os.Stderr, format, args...)
}

// renderWarningf writes warning messages to stderr.
func renderWarningf(format string, args ...any) {
