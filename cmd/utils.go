...
var (
	...
	errServerYAMLOutputRequiresYAML = errors.New(
		"server native yaml output requires yaml output format",
	)
	errServerYAMLOutputUnsupportedVersion = errors.New(
		"server native yaml output requires aerospike version 8.1.1 or newer",
	)
)
