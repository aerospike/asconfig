...
# with all versions of Aerospike or the Community Edition.`)
	res := &cobra.Command{
		...
		This can be useful if you have changed the configuration of a node dynamically (e.g. xdr) \
		and would like to persist the changes.`,
		RunE: func(cmd *cobra.Command, _ []string) error {
			...
			logger.Warning(
				...
				Generated static configuration does not save logging.syslog, mod-lua, service.user and service.group`,
			)
			logger.Warning(
