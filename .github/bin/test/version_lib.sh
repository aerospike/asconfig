...
# The lines `asconfig --version` must print for that string. tools-common-go's
# SetupRoot splits on "-": the core goes on the Version line and the last
# segment, if any, on a Build line.
#
#   0.21.4-rc1        Version 0.21.4 / Build rc1
#   0.21.4-abc123def  Version 0.21.4 / Build abc123def
#   0.21.4            Version 0.21.4
